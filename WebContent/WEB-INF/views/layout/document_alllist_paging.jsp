...
<ul class="pagination pagination-sm">
	...
	<li><a href="/document/list/all?curPage=${paging.startPage + paging.pageCount }&search=${param.search }">&raquo;</a></li>
	</c:if>
	...
	<li><a href="/document/list/all?curPage=${paging.totalPage }&search=${param.search }">&rarr;</a></li>
	</c:if>
</ul>
</div>