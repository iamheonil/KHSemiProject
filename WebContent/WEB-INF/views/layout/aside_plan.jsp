		...
		<ul>
			...
			<nav id="admenu">
				<ul class="aside_nav">
					...
					<li class="sidemenu-content"><a data-toggle="modal" href="#addPlan">일정등록</a></li>
					<li class="sidemenu-content"><a data-toggle="modal" href="#modiPlan">일정수정</a></li>
					<li class="sidemenu-content"><a data-toggle="modal" href="#delPlan">일정삭제</a></li>
				</ul>
			</nav>
