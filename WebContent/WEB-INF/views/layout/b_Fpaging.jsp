...
<ul class="pagination pagination-sm">
	...
	<li><a href="/board/free">&larr;</a></li>
<%-- 	<li><a href="/board/free?curPage=1&&search=${param.search }">&larr;</a></li> --%>
	</c:if>
	...
	<li><a href="/board/free?curPage=${paging.startPage - paging.pageCount }&search=${param.search }&search2=${param.search2 }">&laquo;</a></li>
	</c:if>
	...
	<li><a href="/board/free?curPage=${paging.curPage - 1 }&search=${param.search }&search2=${param.search2 }">&lt;</a></li>
	</c:if>
	...
	<c:if test="${paging.curPage ne i }">
		<li><a href="/board/free?curPage=${i }">${i }</a></li>
	</c:if>
	...
	<li><a href="/board/free?curPage=${paging.totalPage }&search=${param.search }&search2=${param.search2 }">&rarr;</a></li>
	</c:if>
</ul>
</div>
