...
<ul class="pagination pagination-sm">
	...
	<li><a href="/board/free?curPage=${paging.startPage - paging.pageCount }">&laquo;</a></li>
	</c:if>
	...
	<c:if test="${paging.curPage eq i }">
		<li class="active"><a href="/board/free?curPage=${i }">${i }</a></li>
	</c:if>
	...
	<li><a href="/board/free?curPage=${paging.totalPage }&search=${param.search }">&rarr;</a></li>
	</c:if>
</ul>
</div>
