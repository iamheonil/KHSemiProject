...
$(document).ready(function() {
	...
	$("#usergender").blur(function() {
		if($(this).val() != 0) {
			...
			$("#gender_err_msg").text("성별을 입력해주세요.");
			$("#gender_err_msg").css("color", "red")
		}
	})
	...
	$("#joinForm").submit(function() {
		...
		if(($("#uphoto").val()) == "") {
			$("#photo_err_msg").text("필수 정보입니다.");
			$("#photo_err_msg").css("color", "red")
			cnt++;
		}
	...
	<div id="loginLayout">
		<div id="loginForm">
			...
			<div class="Form-content" style="text-align: left;">
				<div id="userphoto"></div><input type="file" name="uphoto" id="uphoto" />
				<div id="photo_err_msg"></div>
			</div>
			<div class="Form-title">
				<label for="userid">사번</label>
			</div>
			<div class="Form-content">
				<input type="text" value="${userid }" disabled="disabled" /> <!-- 값 보여주기만 함. 전송x -->
			</div>
			<div class="Form-title">
			...
			<div class="Form-content" style="display: flex;">
				...
				<div class="content-birth">
					<select name="birth-DD">
						<c:forEach begin="01" end="31" step="1" var="i">
			...
			<div class="Form-content">
				...
				<div id="gender_err_msg"></div>
			</div>
			<div class="Form-title">
				<label for="userphone">휴대전화</label>
			</div>
			<div class="Form-content">
				<input type="text" id="userphone" name="userphone" placeholder="(-)을 포함해서 입력하세요."/>
				<div id="phone_err_msg"></div>
			</div>
			<div class="Form-title">
				주소<input type="button" id="addrBtn" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
			</div>
			<div class="Form-content">
				<input type="text" id="useraddr" name="useraddr" placeholder="주소"/>
			...
			<div class="agree-checkbox">
				<input type="checkbox" name="agree" id="agree" style="width: 18px; height: 18px;" /> <label for="agree">이용약관 동의</label>
				<div id="check_err_msg"></div>
			</div>
			<div class="Form-content">
				<input type="submit" value="회원가입" id="btnForm" />
			</div>		
