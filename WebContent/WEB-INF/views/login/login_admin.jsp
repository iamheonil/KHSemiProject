...
<%-- import header.jsp --%>
<c:import url="/WEB-INF/views/layout/header_login_admin.jsp" />	

	<div id="loginLayout">
		<div id="loginForm">
			
			<form action="/admin/login" method="post" id="joinForm">
...
<%-- import footer --%>
<c:import url="/WEB-INF/views/layout/footer_login_admin.jsp" />
