...
@WebServlet("/document/list/waitapprove")
public class DocumentWaitApproveListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		SearchPaging paging = documentService.getWaitApprovePaging(req);
		System.out.println("waitApproveListController - " + paging);
...
//		System.out.println(waitApproveList);
		...
		//조회결과 MODEL값 전달
		req.setAttribute("waitApproveList", waitApproveList);
		
		req.getRequestDispatcher("/WEB-INF/views/document/waitapprove_list.jsp").forward(req, resp);
	}
}