...
public class ad_B_Paging {
	...
	//총 게시글 수만 입력하는 생성자
	public ad_B_Paging(int totalCount) {
	...
	public ad_B_Paging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public ad_B_Paging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public ad_B_Paging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
