...
//								, item.getName() // 원본 파일의 이름
	...
	@Override
	public void modifyUser_detail(HttpServletRequest req) {
...
//										, item.getName() // 원본 파일의 이름
				...
				System.out.println("회원정보변경에 뭐가 왔을까? " + user_detail);
				
				user_detailDao.updateUser_detail(user_detail);
